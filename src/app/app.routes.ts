...
export const routes: Routes = [
  ...
  { path: 'auth/google/callback', loadComponent: () => import('./pages/auth/oauth-callback.component').then(m => m.OAuthCallbackComponent) },
  { path: 'auth/facebook/callback', loadComponent: () => import('./pages/auth/oauth-callback.component').then(m => m.OAuthCallbackComponent) },
  { path: 'auth/apple/callback', loadComponent: () => import('./pages/auth/oauth-callback.component').then(m => m.OAuthCallbackComponent) },
